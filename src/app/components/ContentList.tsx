...
const mockArticles: ContentListRow[] = [
  {
    id: "1",
...
const mockProducts: ContentListRow[] = [
  {
    id: "1",
...
function row(
  title: string,
  id: string,
  status: ContentListRow["status"] = "published"
): ContentListRow {
  return {
    id,
    title,
...
const GALLERY_COVERS = [
  ...
  "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?w=200&h=200&fit=crop",
...
const mockGalleryItems: ContentListRow[] = [
  {
    id: "3",
    title: "Sunrise over peaks",
    description: "Early light on the ridge line.",
    coverUrl: GALLERY_COVERS[0],
    status: "published",
    locale: "en",
    updatedAt: "2026-04-03",
    updatedBy: "John Doe",
  },
  {
    id: "5",
    title: "Forest trail",
    description: "Moss and pines after rain.",
    coverUrl: GALLERY_COVERS[1],
    status: "published",
    locale: "en",
    updatedAt: "2026-04-02",
    updatedBy: "Jane Smith",
  ...
  },
  {
    id: "9",
    title: "Autumn valley",
    description: "Warm tones, late afternoon.",
    coverUrl: GALLERY_COVERS[3],
    status: "published",
    locale: "en",
  ...
  },
  {
    ...
    description: "Long exposure study.",
    coverUrl: GALLERY_COVERS[4],
    status: "published",
    locale: "en",
  ...
  },
  {
    ...
    description: "Glass and concrete patterns.",
    coverUrl: GALLERY_COVERS[5],
    status: "published",
    locale: "en",
  ...
  },
  {
    id: "16",
    title: "Desert dunes",
    description: "Minimal lines at golden hour.",
    coverUrl: GALLERY_COVERS[6],
    status: "published",
    locale: "en",
  ...
  },
  {
    id: "1",
    title: "test",
    description: "Demo entry without long copy.",
    coverUrl: GALLERY_COVERS[7],
    status: "published",
    locale: "en",
...
const CONTENT_LIST_MOCKS: Record<string, ContentListRow[]> = {
...
function cloneContentMocks(): Record<string, ContentListRow[]> {
  const o: Record<string, ContentListRow[]> = {};
  for (const key of Object.keys(CONTENT_LIST_MOCKS)) {
    o[key] = CONTENT_LIST_MOCKS[key].map((r) => ({ ...r }));
  }
  return o;
}
...
export function ContentList() {
  ...
  const [activeByType, setActiveByType] = useState(cloneContentMocks);
