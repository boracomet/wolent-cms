...
export type CmsBackupFile = {
  ...
  data: {
    ...
    mediaSummary?: { demoFiles: number };
    usersSummary?: { demoAccounts: number };
  ...
  return {
    ...
    data: {
      contentTypesNote: included.contentTypes
        ? "Demo: content type definitions ship with the app; this export records your inclusion flag for a full CMS backup pipeline."
        : undefined,
      mediaSummary: included.mediaLibrary ? { demoFiles: 24 } : undefined,
      usersSummary: included.users ? { demoAccounts: 4 } : undefined,
